...
const DeleteDialog = ({ openDialog, handleClose, dialogTitle, handleSubmit, loading }: DeleteDialogProps) => {
    return (
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform shadow-xl bg-zinc-700 rounded-2xl">
                                ...
                                <div className="w-full text-right">
                                    ...
                                    <br />
                                    <button onClick={handleSubmit} className="w-auto p-2 ml-auto rounded-md bg-zinc-600 hover:bg-zinc-500">
                                        <div className="flex">
                                            {loading ? (
                                                <Loader />
                                            ) : (
